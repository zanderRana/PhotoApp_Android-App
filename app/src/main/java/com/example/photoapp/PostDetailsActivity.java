...
public class PostDetailsActivity extends AppCompatActivity {
    ...
    private void loadComments() {
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Posts").child("post" + postId).child(postId).child("Comments");
    ...
    private void likepost() {
        ...
        liekeref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (mlike) {
                    if (dataSnapshot.child(postId).hasChild(myuid)) {
                        postref.child("post"+ postId).child(postId).child("plike").setValue("" + (Integer.parseInt(plike) - 1));
    ...
    private void postComment() {
        ...
        DatabaseReference datarf = FirebaseDatabase.getInstance().getReference("Posts").child("post" + postId).child(postId).child("Comments");
    ...
    private void updatecommetcount() {
        count = true;
        final DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Posts").child("post" + postId).child(postId);
    ...
    private void loadPostInfo() {
        ...
        db.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                hisname = "" + snapshot.child("name").getValue();
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("Posts/post" + postId);;
